...
?>
<body style="background: url('img/background.png') no-repeat">
...
<a href="https://danieleverest.vercel.app/"><img style="margin: 50px" width="150px" height="100px" src="img/logo.png"></a> 
  ...
  <div id="half-body"> <!--Site background-->
   ...
   <footer>
      Daniel Everest &copy; 2018, All Right Reserved.
      <br>A <a href="https://danieleverest.vercel.app/">Code To Create</a> Production
    </footer>
